...
<html>
  ...
  <head>
    ...
    <form action="" method="post">
      <label>Choose a personality trait, or search for a <a href="./individual.php">specific MP</a>:</label>
    ...
    <h3>Viewing top 10 for <?php echo $selected_val ?></h3>
    <p><a href="./see_all.php">See full list</a></p>
    <table id="results_table">
      ...
      <?php
            while($row = $result->fetch_assoc()){
              ...
              if ($row[$selected_val_rank] <= 10 and $row[$selected_val_rank] > 0){
      ?>
          <tr>
            <td>
              <?php
